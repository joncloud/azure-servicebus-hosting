# Contributing to azure-servicebus-hosting

First and foremost, thank you! We appreciate that you want to contribute to azure-servicebus-hosting, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for azure-servicebus-hosting**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for azure-servicebus-hosting:

- star the [project](https://github.com/joncloud/azure-servicebus-hosting)
- tweet your support for azure-servicebus-hosting
...
- **version**: (required) please note the version of azure-servicebus-hosting are you using
...
The original poster or the maintainers of azure-servicebus-hosting may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/azure-servicebus-hosting
